...
const convertToJsonString = function(node, options) {
    options = buildOptions$2(options,x2j.defaultOptions,x2j.props);
...
exports.parse = function(xmlData, options) {
    options = buildOptions(options,x2j$$1.defaultOptions,x2j$$1.props);
    return n2j.convertToJson(x2j.getTraversalObj(xmlData, options), options);
};
exports.convertTonimn = nimndata.convert2nimn;
exports.getTraversalObj = x2j.getTraversalObj;
exports.convertToJson = n2j.convertToJson;
exports.convertToJsonString = n2j_str.convertToJsonString;
exports.validate = validator.validate;
exports.j2xParser = j2x;
